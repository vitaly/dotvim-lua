...
---------------------------------------------------------------------------------
local function edit_file_map(key, root, path, desc)
  return {
    key,
    function() vim.cmd.edit(root .. path) end,
    desc = 'Edit ' .. desc,
  }
end
  ...
  opts = {
    ...
    keys = {
      ...
      },
      {
        ...
        { '<leader>azX', '<cmd>Lazy Clean<cr>', desc = 'Clear' },
        ...
        { '<leader>azC', '<cmd>Lazy check<cr>', desc = 'Check' },
        ...
        { '<leader>azU', ':<c-u>Lazy update<cr>', desc = 'Update!' },
